      function files_zenodo_send(filename, context, metadata) {
...
function publish(filename, context) {
files_zenodo_send(filename, context, buildmetadata());
}
